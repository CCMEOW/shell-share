...
class FollowViewController: PageController {
    ...
    @IBAction func anotherConch(_ sender: Any) {
        //从后端传过来的另一个海螺的数据
        like = 11;
        collection = 40;
        ...
        singerName.text = byer
        songL = "《"
        byer = "——"
    }
    
    @IBAction func conchDetail(_ sender: Any) {
    ...
    override func viewDidLoad() {
        ...
        //view.backgroundColor = UIColor(patternImage: UIImage(named:"5.1关注背景")!)
    }
